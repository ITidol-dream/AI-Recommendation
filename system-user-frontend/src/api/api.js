...
export const saveSysHotelsComments = (params) => post("/comments/saveSysHotelsComments",params)

export const getSysHotelsIndex = (params) => get("/hotel/getSysHotelsIndex",params)
export const getSysHotelsCommentsPage = (params) => post("/comments/getSysHotelsCommentsPage",params)