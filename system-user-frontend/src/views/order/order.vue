  ...
  <div class="attractions">
    ...
    <div class="order" style="margin-top:20px">
        <el-tabs style="width:80%" v-model="activeName" type="card" @tab-click="handleClick">
            ...
            <el-tab-pane label="知识点" name="second">
                <div class="attractions1">
                    <div class="attractions3">
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" v-if="state != 5 && state != 3 && state != 2 && state != 4" @click="editSysAttractionOrder" size="small">取消规划</el-button>
    </span>
    </el-dialog>
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" v-if="state != 5 && state != 3 && state != 2 && state != 4" @click="editSysHotelOrder" size="small">取消规划</el-button>
    </span>
    </el-dialog>
  </div>
</template>
