    ...
    <div class="attractionsInfo1">
        <div class="attractionsInfo2">
            ...
            <div class="attractionsInfo4">
                ...
                <div class="attractionsInfo5" style="font-size: larger;font-weight: normal">加入时间：{{info.time}}</div>
                ...
                <div class="attractionsInfo7" style="margin-left:15px">
                    <el-button style="margin-top: 50px" size="small" type="primary" plain @click="toOrder">规划学习课程</el-button>
                </div>
            </div>
        </div>
    </div>
    <div class="attractionsInfo1" style="font-family: 'Microsoft YaHei'">
        <div class="attractionsInfo8" >
            <div style="margin-left:20px;margin-right:20px;margin-top:20px;white-space: pre-line">
              <a style="font-weight: bold">章节介绍：</a>{{info.content}}
            </div>
            <div style="margin-left:20px;margin-right:20px;margin-top:20px">
              <a style="font-weight: bold">课程评价：</a>{{info.open}}
            </div>
