          ...
          <el-submenu index="1 ">
            ...
            <el-menu-item index="/user@普通用户管理">
              ...
              <span slot="title">普通用户管理</span>
                ...
                <el-menu-item index="/attractions@课程管理">
                ...
                <el-menu-item index="/order@课程规划">
                    <i class="el-icon-s-promotion"></i>
                    <span slot="title">课程规划</span>
                </el-menu-item>
                <el-menu-item index="/orderHotel@知识规划">
                    <i class="el-icon-s-home"></i>
                    <span slot="title">知识规划</span>
                </el-menu-item>
