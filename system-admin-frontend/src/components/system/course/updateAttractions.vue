        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="open" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.open" size="mini" placeholder="请输入课程评价" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="time" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.time" size="mini" placeholder="请输入加入时间" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
      </el-row>
