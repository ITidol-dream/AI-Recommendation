<template>
<div>
  <el-dialog title="编辑用户知识规划" width="40%" :destroy-on-close="true" :visible.sync="updateVisible" :before-close="handleClose">
    <el-form :model="form" :rules="rules" ref="ruleForm">
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <span class="search-title">学习时间:</span>
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            ...
            <el-form-item prop="price" style="margin-bottom:0">
                <el-input v-model="form.price" size="mini" placeholder="请输入时间" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
      </el-row>
    </el-form>
