<template>
<div>
  <el-dialog title="新增知识" width="40%" :destroy-on-close="true" :visible.sync="addVisible" :before-close="handleClose">
    <el-form :model="form" :rules="rules" ref="ruleForm">
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          ...
          <div style="width:100%">
            <el-form-item prop="factor" style="margin-bottom:0">
              <el-input type="number" v-model="form.factor" size="mini" placeholder="请输入因子" autocomplete="off"></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
