<template>
  <div class="login">
    ...
    <div class="login4">
        <div class="login5">
          <img src="../../../assets/image/logo.png" style="width: 70px;position: relative; top: 13px;right: 6px">
            <div class="login6" style="font-size: 30px">欢迎使用AI课程知识点推荐系统后台</div>
            <div class="login3" style="font-size: 30px">
                管理员登录
            </div>
